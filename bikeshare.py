...
def display_data(df):
    """Truncates Data into rows on 
    5 depending on user input
    """
    print('Would you like to see the next 5 rows of the data, press no to skip')
    next_loc = 0
    while (input() != 'no'):
        next_loc = next_loc+5
        print(df.head(next_loc))
